...
public class Ex3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if(nump == 96) {
				...
				entradaP = JOptionPane.showInputDialog(null, 
						...
						+ "40) Decrescente 1 a 10 \r\n"
						+ "41) Números acima de 100\r\n"
						+ "42) Número de 1 a 100\r\n"
						+ "43) Cronometro\r\n"
						+ "44) Tabuada\r\n"
						+ "45) Números Negativos\r\n"//51
						+"\n\n\n"
						+ "0) Pagina principal \r\n"
						+ "97) Pagina 04\r\n"
		...
		if(nump == 97) {
			...
			entradaP = JOptionPane.showInputDialog(null, 
					"Digite qual de nosso serviços deseja consultar:\n"
					+ "46) Números entre 10 e 20\r\n"
					+ "47) Media de vários números\r\n"
					+ "48) Notas e media de sala \r\n"
					+ "49) Soma vários números\r\n"
					+ "50) Soma com números abaixo de 40\r\n"
					+ "51) Soma entre um valor ate outro\r\n"
					+ "52) XX \r\n"
					+ "53) XX \r\n"
					+ "54) XX \r\n"
					+ "55) XX \r\n"
					...
					+ "0) Pagina principal \r\n"
					+ "98) Pagina 05\r\n"
					+ "99) Saida","Seleção Pg 04",JOptionPane.INFORMATION_MESSAGE);
			nump = Integer.parseInt(entradaP);
			System.out.println(nump);
			if(nump == 0) {
				main(null);
	...
	public static void funcao() throws InterruptedException {
		...
		case 53:
			...
			JOptionPane.showMessageDialog(null,"Sua soma total foi de  " + r);
		main(null);
		break;
		case 54:
