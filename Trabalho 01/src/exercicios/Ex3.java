...
public class Ex3 {
	...
	static double r, r1,r2,r3,r4,r5,r6, total,total1,total2;
	...
	public static void funcao() throws InterruptedException {
		...
		break;
			...
			case 52:
				...
				JOptionPane.showMessageDialog(null,"A media de 15 ate 100 é  " + r);
	
			main(null);
			break;
			case 53:
				for(o2 = 0; o2 > -1; o2++) {
				s = JOptionPane.showInputDialog("Deseja checar seus produtos?\n" + "\"S\" ou \"N\"");
				if(s.equals("S")) {
				i1 = 0; total = 0;
				entradaI1 = JOptionPane.showInputDialog("Digite o tanto de mercadorias : ");
				i1 = Integer.parseInt(entradaI1);
				for(o1 = 1;o1 >= -1; o1++) {
				entradaI = JOptionPane.showInputDialog("Digite o valor: ");
				i = Integer.parseInt(entradaI);
				...
				JOptionPane.showMessageDialog(null, d1 + " Essa seria a media dentro das mercadorias"
						+ "\n e essa seria o valor em estoque " + total);
				}
			...
			case 54:
				entradaI1 = JOptionPane.showInputDialog("Digite quantos valores deseja verificar : ");
				i1 = Integer.parseInt(entradaI1);
				total = 0;
				for(o1 = 1 ;o1 >= -1; o1++) {i = 0;
				entradaI = JOptionPane.showInputDialog("Digite o valor: ");
				i = Integer.parseInt(entradaI);
				...
				JOptionPane.showMessageDialog(null,"O maior numero é  " + total);
			main(null);
			break;
			case 55://71
				entradaI1 = JOptionPane.showInputDialog("Digite quantos valores deseja verificar : ");
				...
				entradaI = JOptionPane.showInputDialog("Digite o valor: ");
				i = Integer.parseInt(entradaI);
				r += i; System.out.println(r);
				total = Math.max(i,total);	r1 = r/i1;
				//System.out.println(i);
				if(o1 >= i1) {break;}
				}
				JOptionPane.showMessageDialog(null,"O maior numero é  " + total + "\n a media é de " + r1);			main(null);
		break;
		...
		case 56:
			...
			entradaI = JOptionPane.showInputDialog("Digite o valor: ");
			i = Integer.parseInt(entradaI);
			total = Math.max(i,total); r =+ i;
			if(o1 >= i1) {break;}
			}
			 r1 = r/i1;
			 JOptionPane.showMessageDialog(null,r1 +  " Essa foi a media,"
			 		+ "\nO maior valor foi " + total);
		main(null);
		break;
		case 57:
			entradaI1 = JOptionPane.showInputDialog("Digite quantos habitates deseja checar : ");
			i1 = Integer.parseInt(entradaI1);
			total = 0;
			for(o1 = 1 ;o1 >= -1; o1++) {i = 0; i2 = 0;
			entradaI = JOptionPane.showInputDialog("Digite o salario: ");
			i = Integer.parseInt(entradaI);
			entradaI2 = JOptionPane.showInputDialog("Digite quantos filhos tem: ");
			i2 = Integer.parseInt(entradaI2);
			total1 += i2;total += i;
			System.out.println(total1);
			total2 = Math.max(i,total2);
			if(i <= 150) {i3++;}
			if(o1 >= i1) {break;}}
			r = total1 /i1; r1 = total / i1;
			JOptionPane.showMessageDialog(null, df.format(r1) + " Media salarial\n"
					+ df.format(r) + " Media de filhos\n"
					+ df.format(total2) + " O maior salario\n"
					+ df.format(i3) +" Numero de pessoas com salario abaixo de R$150");
		...
		case 58:
			for(o1 = 1 ;o1 >= -1; o1++) {
			for(o = 1 ;o >= -1; o++) {r = o * o1;
			System.out.println(o + " X " + o1 + " = " + r);
				if(o >= 10) {break;}}
			if(o1 >= 10) {break;}}			
		main(null);
		break;
